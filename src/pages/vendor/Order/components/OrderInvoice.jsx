    ...
    <Card className="mx-auto my-4 shadow-md rounded-xl border p-8 max-w-2xl invoice-card printable-card">
      ...
      <Row gutter={16} className="mb-4">
        <Col span={12}>
          ...
          <div>Email: findin@gmail.com</div>
        </Col>
      ...
      <Row gutter={16} className="mb-4">
        <Col span={8}>
          <Text>Date:</Text> <Text>{orderData.delivery_date}</Text>
        </Col>
        <Col span={8}>
          <Text>Invoice #:</Text> <Text>{orderData.booking_id}</Text>
        </Col>
        <Col span={8}>
          <Text>Delivery Time:</Text> <Text>{orderData.delivery_time}</Text>
        </Col>
      </Row>
      ...
      <Row className="mb-2" gutter={16}>
        <Col>
          <Text>
            <Text strong>Payment Method:</Text> {orderData.payment.method}
          </Text>
        </Col>
        <Col className="text-right">
          <Text>
            <Text strong>Payment Status:</Text> {orderData.payment.status}
          </Text>
        </Col>
        <Col>
          <Text>
            <Text strong>Transaction ID:</Text> {orderData.payment.txn_id}
          </Text>
        </Col>
      </Row>
